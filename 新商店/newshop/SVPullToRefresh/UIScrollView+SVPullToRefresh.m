...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"上拉可以刷新",),
                             NSLocalizedString(@"松开立即刷新",),
                             NSLocalizedString(@"正在刷新...",),
                                nil];
//        UIView *view1 = [self customViewWithState:0];
//        UIView *view2 = [self customViewWithState:1];
//        UIView *view3 = [self customViewWithState:2];
...
//- (UIView *)customViewWithState:(int)state
//{
//    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 60)];
//    view.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
//    UIImageView *img = [[UIImageView alloc] initWithFrame:CGRectMake(100, 10, 40, 40)];
//    img.tag = 10;
//    [view addSubview:img];
//    
//    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(155, 0, 150, 30)];
//    label.tag = 11;
//    [view addSubview:label];
//    
//    UILabel *subLabel = [[UILabel alloc] initWithFrame:CGRectMake(155, 20, 150, 30)];
//    subLabel.tag = 12;
//    subLabel.font = [UIFont systemFontOfSize:12];
//    
//    subLabel.text = @"最后刷新时间：无";
//
...
//        {
//            label.text = @"上拉可以刷新";
//            img.image = [UIImage imageNamed:@"circle_allow@2x.png"];
//
//        }
//            break;
//        case 1:
//        {
//            label.text = @"松开立即刷新";
//            img.frame = CGRectMake(100, 0, 40, 40);
//            img.image = [UIImage imageNamed:@"kkkkk.png"];
//
//        }
//            break;
//        case 2:
//        {
//            label.frame = CGRectMake(155, 10, 150, 30);
//            label.text = @"正在刷新。。。";
//            subLabel.text = @"";
//            _activityIndicatorView.frame = CGRectMake(100, 10, 40, 40);
...
- (void)setSubtitle:(NSString *)subtitle forState:(SVPullToRefreshState)state {
    ...
    UIView *view1 = [self.viewForState objectAtIndex:0];
    UIView *view2 = [self.viewForState objectAtIndex:1];
    
    UILabel *label1 = (UILabel *)[view1 viewWithTag:12];
    UILabel *label2 = (UILabel *)[view2 viewWithTag:12];
...
- (void)stopAnimating {
                ...
                [[NSUserDefaults standardUserDefaults] setObject:str forKey:@"Refreshdate"];    
    self.state = SVPullToRefreshStateStopped;
