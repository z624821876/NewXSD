...
#define kPRBGColor [UIColor colorWithWhite:0.961 alpha:1.000]
...
- (id)initWithCustomFrame:(CGRect)frame pullingDelegate:(id<PullingRefreshTableViewDelegate>)aPullingDelegate {
